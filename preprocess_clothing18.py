...
file = "/home/optim1/Desktop/won/ldr_rec/data/clothing18/Clothing_Shoes_and_Jewelry_5.json"
raw_df = pd.read_json(file, lines=True)
df = raw_df[["reviewerID", "asin", "overall", "unixReviewTime"]].dropna().reset_index(drop=True)
