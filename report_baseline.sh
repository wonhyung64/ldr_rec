...
experiments=(
    ...
    "./baseline/seq_rec.py --model-name=sasrec --dataset=micro_video --seed=0 --dropout=0.5 --max-seq-len=25"
    "./baseline/seq_rec.py --model-name=sasrec --dataset=micro_video --seed=0 --dropout=0.2 --max-seq-len=25"
    ...
    # "./baseline/seq_rec.py --model-name=grurec --dataset=ml-1m --seed=0 --max-seq-len=200"
    # "./baseline/seq_rec.py --model-name=grurec --dataset=ml-1m --seed=1 --max-seq-len=200"
    # "./baseline/seq_rec.py --model-name=grurec --dataset=ml-1m --seed=2 --max-seq-len=200"
    # "./baseline/seq_rec.py --model-name=grurec --dataset=ml-1m --seed=3 --max-seq-len=200"
    # "./baseline/seq_rec.py --model-name=grurec --dataset=ml-1m --seed=4 --max-seq-len=200"

    # "./baseline/seq_rec.py --model-name=sasrec --dataset=ml-1m --seed=0 --max-seq-len=200 --dropout=0.2"
    # "./baseline/seq_rec.py --model-name=sasrec --dataset=ml-1m --seed=0 --max-seq-len=200 --dropout=0.5"
