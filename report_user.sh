...
experiments=(
    ...
    "expt24_simple_time.py --lr=1e-3 --recdim=64 --lambda1=0.125"
    "expt24_simple_time.py --lr=1e-3 --recdim=64 --lambda1=0.25"
    "expt24_simple_time.py --lr=1e-3 --recdim=64 --lambda1=0.5"
    "expt24_simple_time.py --lr=1e-3 --recdim=64 --lambda1=0.75"
    "expt24_simple_time.py --lr=1e-3 --recdim=64 --lambda1=0.875"
    "expt24_simple_time.py --lr=1e-3 --recdim=128 --lambda1=0.125"
    "expt24_simple_time.py --lr=1e-3 --recdim=128 --lambda1=0.25"
    "expt24_simple_time.py --lr=1e-3 --recdim=128 --lambda1=0.5"
    "expt24_simple_time.py --lr=1e-3 --recdim=128 --lambda1=0.75"
    "expt24_simple_time.py --lr=1e-3 --recdim=128 --lambda1=0.875"
