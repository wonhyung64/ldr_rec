...
#%%
file_dir = "./data"
file = f"{file_dir}/fashion/Amazon_Fashion.jsonl"
...
len(train_dict)
#%%
np.save(f"{file_dir}/fashion/training_dict.npy", train_dict, allow_pickle=True)
np.save(f"{file_dir}/fashion/testing_dict.npy", test_dict, allow_pickle=True)
np.save(f"{file_dir}/fashion/validation_dict.npy", valid_dict, allow_pickle=True)
np.save(f"{file_dir}/fashion/interaction_time_dict.npy", time_dict, allow_pickle=True)
