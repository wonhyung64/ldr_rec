...
experiments=(
    ...
    "expt27_history_aware_residual_patch.py --lr=1e-3 --recdim=64 --lambda1=0.125 --tau=0.5"
    "expt27_history_aware_residual_patch.py --lr=1e-3 --recdim=64 --lambda1=0.25 --tau=0.5"
    "expt27_history_aware_residual_patch.py --lr=1e-3 --recdim=64 --lambda1=0.5 --tau=0.5"
    "expt27_history_aware_residual_patch.py --lr=1e-3 --recdim=64 --lambda1=0.75 --tau=0.5"
    "expt27_history_aware_residual_patch.py --lr=1e-3 --recdim=64 --lambda1=0.875 --tau=0.5"
    "expt27_history_aware_residual_patch.py --lr=1e-3 --recdim=128 --lambda1=0.125 --tau=0.5"
    "expt27_history_aware_residual_patch.py --lr=1e-3 --recdim=128 --lambda1=0.25 --tau=0.5"
    "expt27_history_aware_residual_patch.py --lr=1e-3 --recdim=128 --lambda1=0.5 --tau=0.5"
    "expt27_history_aware_residual_patch.py --lr=1e-3 --recdim=128 --lambda1=0.75 --tau=0.5"
    "expt27_history_aware_residual_patch.py --lr=1e-3 --recdim=128 --lambda1=0.875 --tau=0.5"
