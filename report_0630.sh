...
experiments=(
    ...
    "./baseline/debiased_cf_resid_only.py --model-name=ncf --dataset=kuairand --seed=1 --tau=0.1 --lambda1=0.7 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    "./baseline/debiased_seq_rec_resid_only.py --model-name=grurec --dataset=kuairand --seed=1 --tau=0.1 --lambda1=0.9 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    "./baseline/debiased_seq_rec_resid_only.py --model-name=sasrec --dataset=kuairand --seed=1 --tau=0.1 --lambda1=0.9 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    ...
    "./baseline/debiased_seq_rec_resid_only.py --model-name=bsarec --dataset=kuairand --seed=1 --tau=0.1 --lambda1=0.1 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --alpha=0.9 --c=1 --epochs=500 --ablation=shared"
    ...
    "./baseline/debiased_cf_resid_only.py --model-name=mf --dataset=kuairand --seed=3 --tau=0.1 --lambda1=0.9 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    "./baseline/debiased_cf_resid_only.py --model-name=ncf --dataset=kuairand --seed=3 --tau=0.1 --lambda1=0.7 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    "./baseline/debiased_seq_rec_resid_only.py --model-name=grurec --dataset=kuairand --seed=3 --tau=0.1 --lambda1=0.9 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    "./baseline/debiased_seq_rec_resid_only.py --model-name=sasrec --dataset=kuairand --seed=3 --tau=0.1 --lambda1=0.9 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    ...
    "./baseline/debiased_seq_rec_resid_only.py --model-name=bsarec --dataset=kuairand --seed=3 --tau=0.1 --lambda1=0.1 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --alpha=0.9 --c=1 --epochs=500 --ablation=shared"
    ...
    "./baseline/debiased_cf_resid_only.py --model-name=mf --dataset=kuairand --seed=4 --tau=0.1 --lambda1=0.9 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    "./baseline/debiased_cf_resid_only.py --model-name=ncf --dataset=kuairand --seed=4 --tau=0.1 --lambda1=0.7 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    "./baseline/debiased_seq_rec_resid_only.py --model-name=grurec --dataset=kuairand --seed=4 --tau=0.1 --lambda1=0.9 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    "./baseline/debiased_seq_rec_resid_only.py --model-name=sasrec --dataset=kuairand --seed=4 --tau=0.1 --lambda1=0.9 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    ...
    "./baseline/debiased_seq_rec_resid_only.py --model-name=bsarec --dataset=kuairand --seed=4 --tau=0.1 --lambda1=0.1 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --alpha=0.9 --c=1 --epochs=500 --ablation=shared"
