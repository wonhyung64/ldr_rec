...
experiments=(
    ...
    # "./baseline/debiased_cf_resid_only.py --model-name=mf --dataset=micro_video --seed=1 --tau=0.1 --lambda1=0.1 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_cf_resid_only.py --model-name=mf --dataset=micro_video --seed=2 --tau=0.1 --lambda1=0.1 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_cf_resid_only.py --model-name=mf --dataset=micro_video --seed=3 --tau=0.1 --lambda1=0.1 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_cf_resid_only.py --model-name=mf --dataset=micro_video --seed=4 --tau=0.1 --lambda1=0.1 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"

    # "./baseline/debiased_cf_resid_only.py --model-name=ncf --dataset=micro_video --seed=1 --tau=0.1 --lambda1=0.1 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_cf_resid_only.py --model-name=ncf --dataset=micro_video --seed=2 --tau=0.1 --lambda1=0.1 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_cf_resid_only.py --model-name=ncf --dataset=micro_video --seed=3 --tau=0.1 --lambda1=0.1 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_cf_resid_only.py --model-name=ncf --dataset=micro_video --seed=4 --tau=0.1 --lambda1=0.1 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"

    # "./baseline/debiased_seq_rec_resid_only.py --model-name=grurec --dataset=micro_video --seed=1 --tau=0.1 --lambda1=0.3 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_seq_rec_resid_only.py --model-name=grurec --dataset=micro_video --seed=2 --tau=0.1 --lambda1=0.3 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_seq_rec_resid_only.py --model-name=grurec --dataset=micro_video --seed=3 --tau=0.1 --lambda1=0.3 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_seq_rec_resid_only.py --model-name=grurec --dataset=micro_video --seed=4 --tau=0.1 --lambda1=0.3 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"

    # "./baseline/debiased_seq_rec_resid_only.py --model-name=sasrec --dataset=micro_video --seed=1 --tau=0.1 --lambda1=0.9 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_seq_rec_resid_only.py --model-name=sasrec --dataset=micro_video --seed=2 --tau=0.1 --lambda1=0.9 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_seq_rec_resid_only.py --model-name=sasrec --dataset=micro_video --seed=3 --tau=0.1 --lambda1=0.9 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_seq_rec_resid_only.py --model-name=sasrec --dataset=micro_video --seed=4 --tau=0.1 --lambda1=0.9 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"

    # "./baseline/debiased_seq_rec_tisasrec_resid_only.py --model-name=tisasrec --dataset=micro_video --seed=1 --tau=0.1 --lambda1=0.7 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_seq_rec_tisasrec_resid_only.py --model-name=tisasrec --dataset=micro_video --seed=2 --tau=0.1 --lambda1=0.7 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_seq_rec_tisasrec_resid_only.py --model-name=tisasrec --dataset=micro_video --seed=3 --tau=0.1 --lambda1=0.7 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_seq_rec_tisasrec_resid_only.py --model-name=tisasrec --dataset=micro_video --seed=4 --tau=0.1 --lambda1=0.7 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"

    # "./baseline/debiased_seq_rec_resid_only.py --model-name=fearec --dataset=micro_video --seed=1 --tau=0.1 --lambda1=0.7 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_seq_rec_resid_only.py --model-name=fearec --dataset=micro_video --seed=2 --tau=0.1 --lambda1=0.7 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_seq_rec_resid_only.py --model-name=fearec --dataset=micro_video --seed=3 --tau=0.1 --lambda1=0.7 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    # "./baseline/debiased_seq_rec_resid_only.py --model-name=fearec --dataset=micro_video --seed=4 --tau=0.1 --lambda1=0.7 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"

    # "./baseline/debiased_seq_rec_resid_only.py --model-name=bsarec --dataset=micro_video --seed=1 --tau=0.1 --lambda1=0.3 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --alpha=0.7 --c=1 --epochs=500 --ablation=shared"
    # "./baseline/debiased_seq_rec_resid_only.py --model-name=bsarec --dataset=micro_video --seed=2 --tau=0.1 --lambda1=0.3 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --alpha=0.7 --c=1 --epochs=500 --ablation=shared"
    # "./baseline/debiased_seq_rec_resid_only.py --model-name=bsarec --dataset=micro_video --seed=3 --tau=0.1 --lambda1=0.3 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --alpha=0.7 --c=1 --epochs=500 --ablation=shared"
    # "./baseline/debiased_seq_rec_resid_only.py --model-name=bsarec --dataset=micro_video --seed=4 --tau=0.1 --lambda1=0.3 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --alpha=0.7 --c=1 --epochs=500 --ablation=shared"
    ...
    "./baseline/debiased_seq_rec_resid_only.py --model-name=fearec --dataset=kuairand --seed=1 --tau=0.1 --lambda1=0.5 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    ...
    "./baseline/debiased_seq_rec_resid_only.py --model-name=fearec --dataset=kuairand --seed=3 --tau=0.1 --lambda1=0.5 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
    "./baseline/debiased_seq_rec_resid_only.py --model-name=fearec --dataset=kuairand --seed=4 --tau=0.1 --lambda1=0.5 --dr-anchor=user --pair-reset-interval=5 --evaluate-interval=500 --epochs=500 --ablation=shared"
