...
experiments=(
    ...
    "./baseline/paac.py --dataset=micro_video --seed=$SEED --epochs=500 --evaluate-interval=500 --recdim=128 --lr=0.0001 --tau=0.2  --alpha=0.1 --gamma=0.5"
    ...
    "./baseline/paac.py --dataset=ml-1m --seed=$SEED --epochs=500 --evaluate-interval=500 --recdim=128 --lr=0.001  --tau=0.2  --alpha=0.1 --gamma=0.5"
    ...
    "./baseline/paac.py --dataset=kuairand --seed=$SEED --epochs=500 --evaluate-interval=500 --recdim=128 --lr=0.0001 --tau=0.1  --alpha=0.1 --gamma=0.5"
